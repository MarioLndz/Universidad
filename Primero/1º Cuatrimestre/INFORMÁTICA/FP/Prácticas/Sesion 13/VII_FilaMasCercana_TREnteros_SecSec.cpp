/*****************************************************************************
	...
	Ejercicio 55 - VII: Reescribir el ejercicio 47 (fila más cercana de un 
	conjunto de filas preseleccionadas) usando la clase TablaRectangularEnteros 
	que emplea una secuencia de secuencias de enteros como dato privado.
...
//	Representa una tabla formada por enteros. Consideraremos cada fila una
//	secuencia de enteros formadas por n columnas
...
public:
	...
	SecuenciaEnteros Fila (int indice_fila) {
		...
		for (int col=0; col<cols_utilizadas; col++)
			fila.Aniade(vector_privado[indice_fila].Elemento(col));
