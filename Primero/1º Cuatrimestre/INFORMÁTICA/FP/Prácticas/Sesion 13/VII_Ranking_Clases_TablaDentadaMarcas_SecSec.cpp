/*****************************************************************************
	...
	Ejercicio 62 - VII: Reescriba la solución del ejercicio 52 de esta Relación 
	de Problemas usando como estructura de datos para almacenar la tabla 
	dentada una secuencia de secuencias de datos de tipo RegistroDeMarca 
	(secuencia de SecuenciaMarcas).
...
public:
	...
	TablaDentadaMarcas(int num_pruebas)
		: 	filas_utilizadas(num_pruebas)
	{}
	//------------------------------------------------
	//Métodos de consulta
	int CapacidadFilas(){
	...
	void Aniade(SecuenciaMarcas fila_nueva){
		if(filas_utilizadas < NUM_FILAS){
			...
			//Actualizamos el numero de filas utilizadas
			filas_utilizadas++;
		}
	}
	...
	//------------------------------------------------
	//	Con este metodo sustituimos una fila por otra
...
private:
	//------------------------------------------------
	//	Este metodo reemplazara una fila (a_borrar), por otra
